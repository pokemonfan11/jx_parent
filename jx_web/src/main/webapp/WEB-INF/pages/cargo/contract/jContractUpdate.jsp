    ...
    <div>
		<table class="commonTable" cellspacing="1">
	        ...
	        <tr>
	            ...
	            <td class="tableContent"><textarea name="crequest" style="height:150px;">${crequest}</textarea></td>
	            <td class="columnTitle">说明：</td>
	            <td class="tableContent"><textarea name="remark" style="height:150px;">${remark}</textarea></td>
	        </tr>		
		</table>
	</div>
