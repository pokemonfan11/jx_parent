...
public class Contract extends BaseEntity implements Serializable {
	...
	public String toString() {
		return "Contract [contractProducts=" + contractProducts + ", id=" + id + ", offeror=" + offeror
				+ ", contractNo=" + contractNo + ", signingDate=" + signingDate + ", inputBy=" + inputBy + ", checkBy="
				+ checkBy + ", inspector=" + inspector + ", totalAmount=" + totalAmount + ", crequest=" + crequest
				+ ", customName=" + customName + ", shipTime=" + shipTime + ", importNum=" + importNum
				+ ", deliveryPeriod=" + deliveryPeriod + ", oldState=" + oldState + ", outState=" + outState
				+ ", tradeTerms=" + tradeTerms + ", printStyle=" + printStyle + ", remark=" + remark + ", state="
				+ state + "]";
	}
